...
namespace FinalGUI
{
    public partial class staffdeliveries : Form
    {
        ...
        private void admin_Load(object sender, EventArgs e)
        {
            ...
            txtDriverName.DropDown += txtDname_DropDown;
        }
        private void txtDname_DropDown(object sender, EventArgs e)
        {
            PopulateAvailableNames();
        }
        ...
        private void dataDeliveryId_SelectionChanged(object sender, EventArgs e)
        {
            if (dataDeliveryId.SelectedRows.Count > 0)
            {
                ...
                Console.WriteLine("Driver's Name: " + txtDriverName.Text);

                // Refresh the txtDname control to reflect the change
